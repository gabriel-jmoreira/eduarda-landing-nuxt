<template>
  <div class="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-3">
    ...
    <a :href="instagram" target="_blank" rel="noopener noreferrer" class="group flex items-center justify-center w-12 h-12 rounded-full bg-pink-600 text-white shadow-lg hover:scale-110 transition relative">
