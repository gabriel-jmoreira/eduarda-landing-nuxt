<template>
  <div class="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col gap-3">
    <a :href="whatsapp" target="_blank" class="group flex items-center justify-center w-12 h-12 rounded-full bg-green-600 text-white shadow-lg hover:scale-110 transition relative">
      ...
      <span class="absolute right-full mr-2 px-2 py-1 bg-slate-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition whitespace-nowrap">WhatsApp</span>
    </a>
    <a :href="instagram" target="_blank" rel="noopener noreferrer" @click="openInstagram" class="group flex items-center justify-center w-12 h-12 rounded-full bg-pink-600 text-white shadow-lg hover:scale-110 transition relative cursor-pointer">
      ...
      <span class="absolute right-full mr-2 px-2 py-1 bg-slate-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition whitespace-nowrap">Instagram</span>
    </a>
  </div>
</template>
